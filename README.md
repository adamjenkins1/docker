...
- `OBJECTSTORE_S3_AUTOCREATE` (default: `true`): Whether or not Nextcloud should attempt to create the S3 bucket if it does not exist
...
- `OBJECTSTORE_S3_USEPATH_STYLE` (default: `true`): Not required for AWS S3
